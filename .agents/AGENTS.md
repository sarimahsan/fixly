...
2. **Sequential Execution**: Follow the phase order defined in [map.md](file:///f:/fixly/instructions/map.md) (Phase 0 Foundation → Phase 1 Target Env & Auth → Phase 2 Monitoring → Phase 3 AI & Git → Phase 4 UI Dashboard → Phase 5 E2E Verification).
